...
class CalendarWeekWidgetProvider : AppWidgetProvider() {
    ...
    companion object {
        ...
        fun renderWidget(context: Context, mgr: AppWidgetManager, appWidgetId: Int) {
            ...
            views.setInt(R.id.widgetPrev, "setColorFilter", palette[2])
            views.setInt(R.id.widgetNext, "setColorFilter", palette[2])
            views.setInt(R.id.widgetAdd, "setColorFilter", palette[2])
            views.setInt(R.id.widgetRefresh, "setColorFilter", palette[2])
